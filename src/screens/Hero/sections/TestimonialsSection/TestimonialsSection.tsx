...
const navigationItems = ["All Features", "Blog", "Pricing", "About Us"];

const textToImageModels = [
  { name: "GPT-5", icon: "/vuesax-outline-add-11.svg" },
  { name: "Nano Banana", icon: "/vuesax-outline-add-16.svg" },
  { name: "Mid-Journey", icon: "/vuesax-outline-add-3.png" },
];

const imageToVideoModels = [
  { name: "Stable-diffusion", icon: "/vuesax-outline-add-11.svg" },
  { name: "MiniMax", icon: "/vuesax-outline-add-16.svg" },
...
const generatedImages = [
  {
    ...
    model: "GPT-5",
    icon: "/vuesax-outline-add-11.svg",
    position: "top-0 left-[433px]",
  },
  {
    src: "/frame-2147238729.png",
    model: "Nano Banana",
    icon: "/vuesax-outline-add-16.svg",
...
const connectorImages = [
  ...
  {
    src: "/-connector-9.png",
    position: "top-[62px] left-[295px]",
    size: "w-[130px] h-[182px]",
  },
  {
    src: "/-connector-10.png",
    position: "top-[226px] left-[295px]",
    size: "w-[130px] h-[18px]",
  },
  {
  ...
  },
  {
    ...
    position: "top-[226px] left-[583px]",
    size: "w-[139px] h-[18px]",
  },
  {
    src: "/-connector-13.png",
    position: "top-[60px] left-[583px]",
    size: "w-[139px] h-[182px]",
  },
  {
    src: "/-connector-14.png",
    position: "top-[228px] left-[583px]",
    size: "w-[139px] h-[182px]",
  },
  {
    src: "/-connector-15.png",
    position: "top-[226px] left-[1023px]",
    size: "w-[139px] h-[182px]",
  },
  {
      ...
      <div className="flex flex-col items-center gap-10 relative w-full">
        <header className="flex h-24 items-center justify-between px-16 py-6 relative w-full backdrop-blur-[15px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(15px)_brightness(100%)] bg-[linear-gradient(180deg,rgba(255,255,255,0.04)_0%,rgba(153,153,153,0)_100%)]">
          ...
          <div className="inline-flex items-center gap-2 relative flex-[0_0_auto]">
            <Button className="h-12 px-5 py-[13px] bg-[#ffffff0a] border border-solid border-[#ffffff33] backdrop-blur-[2px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(2px)_brightness(100%)] rounded-xl h-auto">
              <div className="relative flex items-center justify-center w-fit mt-[-1.00px] font-display-XS font-[number:var(--display-XS-font-weight)] text-white text-[length:var(--display-XS-font-size)] text-center tracking-[var(--display-XS-letter-spacing)] leading-[var(--display-XS-line-height)] whitespace-nowrap [font-style:var(--display-XS-font-style)]">
                LOGIN
              </div>
            </Button>

            <Button className="h-12 px-5 py-[13px] border-2 border-solid border-[#ffffff33] bg-[linear-gradient(270deg,rgba(225,183,75,1)_0%,rgba(232,65,99,1)_30%,rgba(166,4,255,1)_62%,rgba(100,0,255,1)_84%,rgba(62,8,224,1)_100%),linear-gradient(0deg,rgba(255,255,255,1)_0%,rgba(255,255,255,1)_100%)] rounded-xl h-auto">
              <div className="relative flex items-center justify-center w-fit mt-[-2.00px] font-display-XS font-[number:var(--display-XS-font-weight)] text-white text-[length:var(--display-XS-font-size)] text-center tracking-[var(--display-XS-letter-spacing)] leading-[var(--display-XS-line-height)] whitespace-nowrap [font-style:var(--display-XS-font-style)]">
                GET STARTED NOW
              </div>
            </Button>
          </div>
          ...
          <div className="relative w-full max-w-[1312px] h-[470px] overflow-hidden">
            <Card className="flex flex-col w-72 h-[470px] items-start justify-center gap-3 p-4 absolute top-[calc(50.00%_-_235px)] left-0 bg-[#ffffff1f] rounded-2xl overflow-hidden">
              <CardContent className="p-0 w-full space-y-3">
                ...
                <Separator className="relative w-full h-px" />
                ...
                <div className="flex flex-col items-start gap-1 relative w-full">
                  ...
                  <div className="items-center gap-2 flex p-3 relative w-full bg-[#ffffff14] rounded-xl border border-solid border-[#ffffff1f]">
                    <Textarea
                      ...
                      className="flex-1 bg-transparent border-none resize-none opacity-80 [font-family:'Instrument_Sans',Helvetica] font-normal text-white text-base tracking-[-0.48px] leading-[22.4px] p-0"
                    />
                  </div>
                </div>
                ...
                <div className="flex flex-col items-start gap-1 relative w-full">
                  ...
                  <div className="flex-wrap items-center gap-[8px_8px] flex p-3 relative w-full bg-[#ffffff14] rounded-xl border border-solid border-[#ffffff1f]">
                    {textToImageModels.map((model, index) => (
                      <Badge
                        key={index}
                        className="inline-flex items-center justify-center gap-1 p-1 bg-[#ffffff1f] rounded-[40px] border border-solid"
                      >
                        <div
                ...
                <Button className="flex h-9 px-4 py-2 w-full bg-white overflow-hidden items-center justify-center gap-2 relative rounded-xl h-auto">
                  <div className="relative flex items-center justify-center w-fit mt-[-2.00px] font-display-XS font-[number:var(--display-XS-font-weight)] text-neutral-800 text-[length:var(--display-XS-font-size)] text-center tracking-[var(--display-XS-letter-spacing)] leading-[var(--display-XS-line-height)] whitespace-nowrap [font-style:var(--display-XS-font-style)]">
                    GENERATE
                  </div>
                  <img
                    className="relative w-4 h-4"
            ...
            <Card className="flex flex-col w-72 h-[408px] items-start justify-center gap-3 p-4 absolute top-[calc(50.00%_-_204px)] left-[728px] bg-[#ffffff1f] rounded-2xl overflow-hidden">
              <CardContent className="p-0 w-full space-y-3">
                ...
                <div className="flex flex-col items-start gap-1 relative w-full">
                  ...
                  <div className="h-[134px] items-start gap-2 flex p-3 relative w-full bg-[#ffffff14] rounded-xl border border-solid border-[#ffffff1f]">
                    <Textarea
                      ...
                      className="relative flex-1 self-stretch mt-[-1.00px] opacity-80 [font-family:'Instrument_Sans',Helvetica] font-normal text-white text-base tracking-[-0.48px] leading-[22.4px] overflow-hidden text-ellipsis [display:-webkit-box] [-webkit-line-clamp:4] [-webkit-box-orient:vertical] bg-transparent border-none resize-none p-0"
                    />
                  </div>
                </div>
            ...
            {connectorImages.map((connector, index) => (
              <img
                key={index}
                className={`absolute ${connector.position} ${connector.size}`}
                alt="Connector"
                src={connector.src}
              />
            ))}
